...
if($_SERVER['SERVER_NAME']=='localhost'):
	...
	$config['mongo_db']['default']['username'] 					= 	'interviewerruser';
	$config['mongo_db']['default']['password'] 					= 	'interviewerr@18052020';
	$config['mongo_db']['default']['database'] 					= 	'interviewerr';
...
/////////////   Algosoft AWS 		/////////////////	
elseif($_SERVER['SERVER_NAME']=='18.189.202.50'):
	$config['mongo_db']['default']['no_auth'] 					= 	FALSE;
	$config['mongo_db']['default']['hostname'] 					= 	'localhost';
	$config['mongo_db']['default']['port'] 						= 	'27017';
	$config['mongo_db']['default']['username'] 					= 	'interviewerruser';
